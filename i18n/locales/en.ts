export default {
  ui: {
    ...
    startWriting: 'Start writing markdown… Try Ctrl+Space for snippets.',
    suggestCalloutInfo: 'Informational callout',
    suggestCalloutInfoDetail: 'Insert NOTE callout snippet',
    suggestCalloutTip: 'Tip callout',
    suggestCalloutTipDetail: 'Insert TIP callout snippet',
    suggestCalloutImportant: 'Important callout',
    suggestCalloutImportantDetail: 'Insert IMPORTANT callout snippet',
    suggestCalloutWarning: 'Warning callout',
    suggestCalloutWarningDetail: 'Insert WARNING callout snippet',
    suggestCalloutCaution: 'Caution callout',
    suggestCalloutCautionDetail: 'Insert CAUTION callout snippet',
    suggestHeadings: 'Headings',
    suggestHeadingsDetail: 'Insert heading levels',
    suggestUnorderedList: 'Bullet list',
    suggestUnorderedListDetail: 'Insert unordered list',
    suggestOrderedList: 'Numbered list',
    suggestOrderedListDetail: 'Insert ordered list',
    suggestChecklist: 'Checklist',
    suggestChecklistDetail: 'Insert markdown task list',
    suggestTable: 'Table',
    suggestTableDetail: 'Insert markdown table starter',
    suggestLink: 'Link',
    suggestLinkDetail: 'Insert markdown link',
    suggestImage: 'Image',
    suggestImageDetail: 'Insert markdown image',
    suggestCodeBlock: 'Code block',
    suggestCodeBlockDetail: 'Insert fenced code block',
    suggestBlockquote: 'Blockquote',
    suggestBlockquoteDetail: 'Insert quoted text',
    suggestDivider: 'Divider',
    suggestDividerDetail: 'Insert horizontal rule',
    suggestDetails: 'Collapsible section',
    suggestDetailsDetail: 'Insert HTML details block',
    suggestPreviewLabel: 'Preview',
    suggestHint: 'Type to filter, or press Ctrl+Space for snippet suggestions with preview.',
